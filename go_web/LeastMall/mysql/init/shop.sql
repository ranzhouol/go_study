...
INSERT INTO `menu` VALUES (3, '秒杀', '/seckill_1.html', 1, 2, '1', 10, 1, 0);
COMMIT;
...
INSERT INTO `product` VALUES (2, '笔记本', '', '', 1, 1, 5, 3999.00, 4699.00, '', '', '', 'static/upload/20201203/1607005081317798000.png', '', '', '1', '', '', '', 0, 0, 1, 0, 1, 0, 1, 0);
INSERT INTO `product` VALUES (3, '手机', '', '', 1, 100, 0, 0.00, 0.00, '', '', '', '', '', '', '', '', '', '', 0, 0, 1, 0, 0, 0, 1, 1607005027);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `product_attr` VALUES (2, 2, 1, 1, 'go', 3, 'go web\r\n', 10, 1607005081, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `setting` VALUES (1, 'LeastMall商城', 'ab', 'LeastMall商城', 'LeastMall商城', 'a', 'LeastMall商城', '88888888', 'LeastMall商城', 'dd', 'dd', 'gg', 'gg', 'gggg', 1);
COMMIT;
